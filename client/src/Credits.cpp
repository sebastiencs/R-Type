  ...
  : engine(std::move(eng))
{
	...
	authors.push_front(new TextField("                Clement Da Silva", Transformation(250, 300 + 35 * 5), 32, "Fipps.otf", Color::White, "DKev", engine));
	...
	authors.push_front(new TextField("                Clement Da Silva", Transformation(250, 300 + 35 * 10), 32, "Fipps.otf", Color::White, "GKev", engine));
