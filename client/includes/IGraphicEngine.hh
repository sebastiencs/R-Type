...
public:
  ...
  virtual void drawSplitImage(const std::string& name, const Transformation& transformation, const Color& color, const int x, const int y, const int width, const int height) = 0;
